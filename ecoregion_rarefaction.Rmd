...
CSHOB_coverage <- coverager(Cali_Coastal_Sage_Chap_Oak_Woodlands_Bees, manual_qs = 7)
CVB <- coverager(Central_Cali_Valley_Bees) 
SBB <- coverager(Southern_and_Baja_Cali_PineOak_Mounts_Bees, manual_qs = 10)
NBRB <- coverager(Northern_Basin_and_Range_Bees, manual_qs = 2)
SDB <- coverager(Sonoran_Desert_Bees, manual_qs = 10)
ECSB <- coverager(Eastern_Cascades_Slopes_and_Foothills_Bees, manual_qs = 10)
