...
```{r}
Corrected_apidae_canonical <- gnr_resolve(sci = apidae_data_SN$scientific_name, data_source_ids = Get_Disc_Life, canonical = TRUE)
# Gives us 69 names as opposed to the 70 we had before, indicating one of them was removed. 
